...
const projectsData = [
  ...
  const seminarsData = [
    ...
    },
    {
      ...
      desc: "The Sangguniang Kabataan of Barangay San Isidro attended the Provincial SK Congress 2025 held at Awesome Hotel in San Juan, La Union, from June 14–16, 2025. The event was organized and led by SK Federation President and Board Member Bhenj Felismino.\n\nThe congress focused on addressing the challenges faced by SK officials, sharing possible solutions, and presenting effective practices from different parts of the country. It also served as a platform for young leaders across Laguna to connect, learn, and collaborate with one another. Vince Villanueva, SK Kagawad of Barangay San Isidro, attended the said event.",
      img: youthcongress
   }
  ];
  ...
  },
  {
    ...
    date: "July 09, 2024",
    desc: "Celebrating the graduation of SK Kagawad Mai Mai Fresco, recognizing her hard work in balancing academic excellence with community leadership.",
    img: maiPhoto,
  ...
  },
  {
    ...
    date: "April 30, 2026",
    desc: "Recognizing outstanding youth leaders and exceptional achievers honored at the prestigious Dangal ni Gat Tayaw awards for community contribution.",
    img: dangalPhoto,
  ...
  },
  {
    ...
    date: "May 16, 2026",
    desc: "Celebrating the provincial-level nomination highlighting exceptional leadership, student advocacy, and academic merit within the collegiate sector.",
    img: gawadPhoto,
