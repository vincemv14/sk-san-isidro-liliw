  ...
  return (
    <nav className="navbar">
      ...
      <ul className={isOpen ? "nav-links active" : "nav-links"}>
        ...
        <li>
          <NavLink to="/people" onClick={closeMenu} className={({ isActive }) => isActive ? "active-link" : ""}>
            <span className="link-text">People</span>
            <span className="chevron-icon"></span>
          </NavLink>
        </li>
        <li>
          <NavLink to="/activities" onClick={closeMenu} className={({ isActive }) => isActive ? "active-link" : ""}>
            <span className="link-text">Activities</span>
            <span className="chevron-icon"></span>
          </NavLink>
        </li>
        <li>
          <NavLink to="/disclosure" onClick={closeMenu} className={({ isActive }) => isActive ? "active-link" : ""}>
